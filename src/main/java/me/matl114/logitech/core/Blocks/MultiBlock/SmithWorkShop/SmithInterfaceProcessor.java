...
public class SmithInterfaceProcessor extends SmithingInterface implements MachineProcessHolder<MultiCraftingOperation> {
    ...
    public static HashSet<Function<AnvilInventory, Supplier<MultiCraftingOperation>>> getAnvilLogics() {
        return anvilLogics;
    }
    ...
    public static EnumMap<SmithOperation, HashSet<Function<SmithingInventory, Supplier<MultiCraftingOperation>>>> getSmithLogics() {
        return smithLogics;
    }
    ...
    public static HashSet<Function<GrindstoneInventory, Supplier<MultiCraftingOperation>>> getGrindStoneLogics() {
        return grindStoneLogics;
    }
